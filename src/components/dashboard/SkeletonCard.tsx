export function SkeletonCard({ className }: { className?: string }) {
  return (
    <div className={`p-6 rounded-3xl bg-[var(--color-card)] border border-white/5 relative overflow-hidden flex flex-col justify-between min-h-[240px] animate-pulse ${className}`}>
      <div className="relative z-10">
        <div className="w-12 h-12 rounded-full bg-white/5 mb-6" />
